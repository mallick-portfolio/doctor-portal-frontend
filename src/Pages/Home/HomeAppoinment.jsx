...
const HomeAppoinment = () => {
  return (
    <div className="hero lg:px-12 mx-auto my-28" style={{ backgroundImage: `url(${appoinment})` }}>
  <div className="hero-content py-0 flex-col lg:flex-row">
    <img src={doctor} className="lg:max-w-lg -mt-28 hidden lg:block" alt='' />
    <div className='text-white p-3 md:p-4 lg:p-6'>
      <h1 className="text-xl text-secondary">Appointment</h1>
